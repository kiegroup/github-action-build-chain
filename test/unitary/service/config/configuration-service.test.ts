...
describe("cli", () => {
    ...
    test.each([
        ...
        ["option skipExecution set to false and skipProjectExecution contains project name", {project: "abc"}, {...defaultInputValues, skipProjectExecution: ["abc"]}, true],
        ["option skipExecution set to false and skipProjectExecution does not contain project name", {project: "abc"}, {...defaultInputValues, skipProjectExecution: ["def"]}, false],
