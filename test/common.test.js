...
test("dependenciesToObject without branch", () => {
  ...
  // Act
  const dependencies = dependenciesToObject('projectA,projectB, projectC,projectD');
  // Assert
...
test("dependenciesToObject with branch", () => {
  // Arrange
  const expected = { 'projectA': {}, 'projectB': { 'mapping': { 'source': '7.x', 'target': 'master' } }, 'projectC': {}, 'projectD': {} };
  // Act
