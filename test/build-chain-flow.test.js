...
const { checkoutDependencies, getDir, readWorkflowInformation } = require('../src/lib/build-chain-flow-helper');
...
test("treatParents", async () => {
  ...
  const workflowInformation = {
    ...
    'childDependencies': { 'projectB': { 'mapping': { 'source': '7.x', 'target': 'master' } }, 'projectC': {} },
